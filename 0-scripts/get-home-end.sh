...
echo "This script will help you get the .inputrc lines for setting:"
echo "  CTRL+HOME => delete to start of line"
echo "  CTRL+END => delete to end of line"
echo
echo "Please press the requested keys when prompted."
echo "--------------------------------------------------------------------"
...
HOME_SEQ=$(read_key_sequence "Press the HOME key:")
echo "You pressed HOME: $HOME_SEQ"

echo # Add a blank line for separation
END_SEQ=$(read_key_sequence "Press the END key:")
