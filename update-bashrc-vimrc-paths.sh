...
SCRIPT_PATH="$HOME/new_linux/0-new-system/new1-add-paths.sh"
...
SCRIPT_PATH="$HOME/new_linux/0-new-system/new1-vimrc.sh"
...
SCRIPT_PATH="$HOME/new_linux/0-new-system/new1-update-h-scripts.sh"
