    ...
    while True:
        try:
            ...
            if key == curses.KEY_UP:
                ...
                current_column += 1
                # Adjust current_row to stay within bounds of the new column
                ...
                checked = [select_all] * len(options)  # Set all to selected or deselected based on state
            elif key == ord("x"):  # Execute selected scripts
                # Return the list of selected scripts
