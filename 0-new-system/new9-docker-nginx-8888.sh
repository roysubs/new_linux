...
echo "Docker note-taking web-app on nginx port 8888"
echo "Template for a basic nginx docker setup"
...
#     -p 8888:80 -v "/home/user/new_linux/0-scripts/webapp:/usr/share/nginx/html:ro" \
#     -v "/home/user/new_linux/0-scripts/webapp/default.conf:/etc/nginx/conf.d/default.conf:ro" \
#     nginx:latest
