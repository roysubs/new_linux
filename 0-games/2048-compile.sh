...
# 7. Create ~/bin if it doesn't exist
if [ ! -d "$BIN_DIR" ]; then
...
echo "You can typically do this by adding the following line to your ~/.bashrc, ~/.zshrc, or equivalent shell configuration file:"
